...
public abstract  class BaseServiceImpl<T> implements BaseService<T>{
	...
	public void deleteByName(Serializable name) {
		this.getBaseDao().deleteByName(name);
	}
	...
	public void updateByName(T entity) {
         this.getBaseDao().updateByName(entity);
	}
     ...
     * @return  
     */  
	public T load(Serializable name) {
		return this.getBaseDao().load(name);
	}
     ...
     * @return
     */
	public T getById(Serializable name) {
